      ...
      <footer className="footer p-10 bg-base-200 text-base-content">
        ...
        <form>
          ...
          <fieldset className="form-control w-80">
            <h1 className="text-xl text-primary font-bold">+009 3456 768</h1>
            <p className="text-sm">talenify@gmail.com</p>
          </fieldset>
        </form>
      </footer>
      <div className="text-center py-4">
        <small className="text-center text-primary py-4">
          Copyright © 2023 - All right reserved by Talenify
        </small>
      </div>
    </div>
  );
